;
if (CloudflareApps.matchPage(CloudflareApps.installs['9pVCSb25f3jr'].URLPatterns)) {
    (function(modules) {
        ...
        (function() {
            ...
            function setFixedElementStyles() {
                ...
                Array.prototype.forEach.call(allNodes, function(node) {
                    ...
                    if ("9pVCSb25f3jr" === 'preview' && node.nodeName === 'IFRAME' && node.src.indexOf('https://embedded.cloudflareapps.com') !== -1) {
                        return
                    }
                ...
                Array.prototype.forEach.call(adjustedNodes, function(node) {
                    ...
                    if (isFixedOrSticky && isShown() && elementHeight > 0) {
                        var newTop = (parseInt(computedStyle.top, 10) || 0) + elementHeight
            ...
            function updateElement() {
                ...
                if ("9pVCSb25f3jr" !== 'preview' && (!shouldShow || hasSeenHash())) {
                    hideWelcomeBar()
                    return
                }
                updateElementStyle()
            ...
            window.CloudflareApps.installs['9pVCSb25f3jr'].scope = {
                ...
                updateTheme: function updateTheme(nextOptions) {
                    var themeStyleChanged = nextOptions.theme.style !== options.theme.style
                    options = nextOptions
                    updateElementStyle()
